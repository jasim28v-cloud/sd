...
function toggleGlobalMute() {
    ...
    const btns = document.querySelectorAll('.side-btn:first-child i');
...
function copyLink() { navigator.clipboard.writeText(currentShareUrl); alert('تم نسخ الرابط'); closeShare(); }
...
function reportVideo() { alert('تم الإبلاغ عن الفيديو'); closeShare(); }
...
async function loadProfileData(userId) {
    ...
    document.getElementById('profileAvatarDisplay').innerText = user.avatar || '👤';
